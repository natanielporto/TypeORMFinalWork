...
export default class AddCompositionFixed1594236855176
  implements MigrationInterface {
  name = 'AddCompositionFixed1594236855176';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "label" DROP COLUMN "colunaNova"`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "artist" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "label" ADD "colunaNova" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "music" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "music" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "artist" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
